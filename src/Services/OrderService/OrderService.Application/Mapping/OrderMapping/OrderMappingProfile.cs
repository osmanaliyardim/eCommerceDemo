...
public class OrderMappingProfile : Profile
{
    public OrderMappingProfile()
    {
        ...
        CreateMap<OrderService.Domain.AggregateModels.OrderAggregate.OrderItem, OrderItemDTO>()
            .ReverseMap();
        ...
        CreateMap<OrderService.Domain.AggregateModels.OrderAggregate.OrderItem, 
            OrderService.Application.Features.Queries.ViewModels.OrderItem>();
    }
}