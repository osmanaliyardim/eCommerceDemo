...
public class Order : BaseEntity, IAggregateRoot
{
    ...
    public Order(string userName, Address address, int cardTypeId,
    ...
    {
        var orderStartedDomainEvent = new OrderStartedDomainEvent(userName, cardTypeId,
            cardNumber, cardSecurityNumber, cardHolderName, cardExpiration, this);
